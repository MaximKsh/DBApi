...
RUN echo "shared_buffers = 10MB" >> /etc/postgresql/$PGVER/main/postgresql.conf
RUN echo "dynamic_shared_memory_type = none" >> /etc/postgresql/$PGVER/main/postgresql.conf
